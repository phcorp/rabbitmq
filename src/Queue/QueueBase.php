    ...
    if ($exchanges) {
      foreach ($exchanges as $exchangeName => $exchange) {
        $this->connection->channel()->exchange_declare(
          $exchangeName,
          isset($exchange['type']) && NULL !== $exchange['type'] ? $exchange['type'] : 'direct',
          isset($exchange['passive']) && NULL !== $exchange['passive'] ? $exchange['passive'] : FALSE,
          isset($exchange['durable']) && NULL !== $exchange['durable'] ? $exchange['durable'] : TRUE,
          isset($exchange['auto_delete']) && NULL !== $exchange['auto_delete'] ? $exchange['auto_delete'] : FALSE,
          isset($exchange['internal']) && NULL !== $exchange['internal'] ? $exchange['internal'] : FALSE,
          isset($exchange['nowait']) && NULL !== $exchange['nowait'] ? $exchange['nowait'] : FALSE
        );
      }
    }
  }
    ...
    if (!isset($this->queue)) {
      ...
      try {
        $this->queue = $channel->queue_declare(
          $this->name,
          isset($actualOptions['passive']) && NULL !==$actualOptions['passive'] ? $actualOptions['passive'] : FALSE,
          isset($actualOptions['durable']) && NULL !==$actualOptions['durable'] ? $actualOptions['durable'] : TRUE,
          isset($actualOptions['exclusive']) && NULL !==$actualOptions['exclusive'] ? $actualOptions['exclusive'] : FALSE,
          isset($actualOptions['auto_delete']) && NULL !==$actualOptions['auto_delete'] ? $actualOptions['auto_delete'] : TRUE,
          isset($actualOptions['nowait']) && NULL !==$actualOptions['nowait'] ? $actualOptions['nowait'] : FALSE,
          isset($actualOptions['arguments']) && NULL !==$actualOptions['arguments'] ? $actualOptions['arguments'] : NULL,
          isset($actualOptions['ticket']) && NULL !==$actualOptions['ticket'] ? $actualOptions['ticket'] : NULL
        );
      }
